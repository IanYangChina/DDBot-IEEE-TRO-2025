...
class DomaEnv(gym.Env):
    ...
    Base env class.
    """
    def __init__(self, horizon=500, horizon_action=500, dt_global=0.001, n_substeps=10,
                 n_substeps_local_multiplier=2, grid_scale=1,
                 ...
                 ckpt_dest='cpu', debug_grad=False, logger=None):
        if seed is not None:
            self.seed(seed)
        ...
        self.mpm_env = MPMEnv(
            ...
            n_substeps_local_multiplier=n_substeps_local_multiplier,
