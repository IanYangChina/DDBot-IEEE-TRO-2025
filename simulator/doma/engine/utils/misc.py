...
def reset_taichi(DTYPE_TI, cuda_GB, seed=0):
    ti.reset()
    ti.init(arch=ti.cuda, default_fp=DTYPE_TI, default_ip=ti.i32, fast_math=True, random_seed=seed,
            debug=False, check_out_of_bound=False, device_memory_GB=cuda_GB,
            advanced_optimization=True, verbose=False)
