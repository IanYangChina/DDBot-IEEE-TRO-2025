...
sim_v_1[:tr1_n_steps_1, 0] = 0.09 / tr1_dt_1
...
sim_v_1[tr1_n_steps_1:tr1_n_steps_1 + tr1_n_steps_2, 2] = -0.05 / tr1_dt_2
...
sim_v_1[tr1_n_steps_1 + tr1_n_steps_2:tr1_n_steps_1 + tr1_n_steps_2 + tr1_n_steps_3, 0] = -0.12 / tr1_dt_3
...
sim_v_1[tr1_n_steps_1 + tr1_n_steps_2 + tr1_n_steps_3:tr1_n_steps_1 + tr1_n_steps_2 + tr1_n_steps_3 + tr1_n_steps_4, 2] = 0.12 / tr1_dt_4
...
sim_v_1 = sim_v_1[:tr1_n_steps_1 + tr1_n_steps_2 + tr1_n_steps_3 + tr1_n_steps_4, :]
...
sim_v_2[:tr2_n_steps_1, 0] = 0.09 / tr2_dt_1
sim_v_2[:tr2_n_steps_1, 1] = 0.09 / tr2_dt_1
sim_v_2[:tr2_n_steps_1, 5] = (np.pi / 4) / tr2_dt_1
...
sim_v_2[tr2_n_steps_1:tr2_n_steps_1 + tr2_n_steps_2, 2] = -0.05 / tr2_dt_2
...
sim_v_2[tr2_n_steps_1 + tr2_n_steps_2:tr2_n_steps_1 + tr2_n_steps_2 + tr2_n_steps_3, 0] = -0.12 / tr2_dt_3
sim_v_2[tr2_n_steps_1 + tr2_n_steps_2:tr2_n_steps_1 + tr2_n_steps_2 + tr2_n_steps_3, 1] = -0.12 / tr2_dt_3
...
sim_v_2[tr2_n_steps_1 + tr2_n_steps_2 + tr2_n_steps_3:tr2_n_steps_1 + tr2_n_steps_2 + tr2_n_steps_3 + tr2_n_steps_4, 2] = 0.12 / tr2_dt_4
...
sim_v_2 = sim_v_2[:tr2_n_steps_1 + tr2_n_steps_2 + tr2_n_steps_3 + tr2_n_steps_4, :]
