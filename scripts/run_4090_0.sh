...
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 1 --line-search --lr 0.02 --demon
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 2 --line-search --lr 0.02 --demon
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 3 --line-search --lr 0.02 --demon
