...
python run_so_abs0.py --ptcl_d 5e6 --cuda_GB 12 --task-id 0 --line-search --lr 0.004 --demon
...
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 0 --line-search --lr 0.005 --demon
...
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 0 --line-search --lr 0.03 --demon
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 0 --lr 0.03
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 0 --lr 0.03 --line-search
python run_so_abs2.py --ptcl_d 5e6 --cuda_GB 12 --task-id 0 --lr 0.03 --demon
