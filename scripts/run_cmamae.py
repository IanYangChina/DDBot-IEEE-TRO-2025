...
def main(arguments):
    ...
    log_dir = os.path.join(result_dir_from_legacy_log(f'log-abs2-cmamae{mat}'), f'd{ptcl_d}-task-{task_id}{suffix}', f'seed-{seed}')
    ...
    with open(data_config_path('cma_mae_config.json'), 'rb') as f_ac:
